...
{
    {
        ...
        Note note3(addr.a_pk, 21416000000000001, random_uint256(), random_uint256());
        increment_note_witnesses(note3.cm(), witnesses, tree);
        Note note4(addr.a_pk, 19000000000000000, random_uint256(), random_uint256());
        increment_note_witnesses(note4.cm(), witnesses, tree);
        Note note5(addr.a_pk, 19000000000000000, random_uint256(), random_uint256());
